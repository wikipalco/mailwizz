...
class WikipalPaymentHandler extends PaymentHandlerAbstract
{
    ...
    public function renderPaymentView()
    {
        ...
        $notifyUrl = Yii::app()->createAbsoluteUrl('payment_gateway_ext_wikipal/ipn');
    ...
    public function processOrder()
    {
        ...
        $transaction->payment_gateway_name = 'WikiPal - www.wikipal.co';
        ...
        $message = Yii::t('payment_gateway_ext_wikipal', 'Your order is in "{status}" status, it usually takes a few minutes to be processed and if everything is fine, your pricing plan will become active!', array(
